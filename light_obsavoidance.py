...
* Filename    : light_obsavoidance.py
* Description : An example for sensor car kit to follow user input light
* Author      : Dream
* Brand       : SunFounder
...
def state_light():
	...
	while True:
		...
		if	lt_status_now in ([0,1,0],[1,1,1]):
			light_flag = 0
		# turn right
		elif lt_status_now in ([1,1,0],[0,1,0]):
			light_flag = 1
		# turn left
		elif lt_status_now in ([1,0,1],[0,0,1]):
			light_flag = 2
		# backward
